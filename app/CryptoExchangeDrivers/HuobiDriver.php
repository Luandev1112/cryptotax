 ...
 *
 * @property \ccxt\huobi $api
 */
class HuobiDriver extends Driver
{
    ...
    // Get coins balances from HuobiDriver crypto exchange 
    ...
    public function fetchCointransactions($symbol_index = 0)
    {
        ...
        while (true) {
            ...
            $trades = $this->api->fetch_my_trades();
